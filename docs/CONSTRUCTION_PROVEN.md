...
TERMINAL_TAG_RULESET = 23629930
CONSTRUCTION_IMMUTABLE_SEAL = construction-seal/v1.1.10
RELEASE_IMMUTABLE_MIRROR = release-seal/v1.1.10
CANONICAL_HARDENING_SEAL = hardening-seal-v2/v1.1.10
SUPERSEDED_HARDENING_SEAL = hardening-seal/v1.1.10 (INVALID_SHA_MISMATCH)
RELEASE = v1.1.10
